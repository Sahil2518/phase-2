"""
zip_task25.py
Packages Task 25 deliverables into a zip archive per standing instructions.
"""
import zipfile
import os
import datetime
...
def main():
    ...
    try:
        with zipfile.ZipFile(zip_name, "w", zipfile.ZIP_DEFLATED) as zf:
            ...
            for f in [f"run_task{task_num:02d}.bat", "requirements.txt", "README.md", "zip_task25.py"]:
                if os.path.exists(f):
                    zf.write(f)
